...
ggplot(data=MA,aes(x=candidate_name,y=FOR, fill=incumbent))+
  geom_bar(stat="identity",aes(size = ifelse(ge_winner == "W", 2, 1)))+
  theme_minimal()
...
ggplot(data=MA,aes(x=candidate_name,y=AGAINST, fill=incumbent))+
  ...
  labs(title ="MA Candidates", 
       subtitle="1973-1974 models",
       caption ="Source: mtcars")+
  scale_y_discrete("Contributions Against Candidates (USD)")+                             #rename y -axis
...
#aes(family = ifelse(ge_winner=="W","Roboto Black", "Roboto Light")
```
