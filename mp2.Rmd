...
contr_incum_FA$ge_winner <- as.factor(contr_incum_FA$ge_winner)

a<- ifelse(contr_incum_FA$ge_winner=="W", "red", "blue")
...
ggplot(data=contr_incum_FA,aes(x=candidate_name, y = totalDonation))+
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, colour = a),
        panel.grid.major = element_blank())+
  geom_text(data=low_values, angle = 90, aes(label =totalDonation, hjust = 0),position = position_dodge(width = 0.9))+
