...
ggplot(data=contr_incum_FA,aes(x=candidate_name, y = totalDonation))+
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1),
        panel.grid.major = element_blank())+
  geom_text(aes(label = contr_incum_FA$totalDonation, hjust = 0),position = position_dodge(width = 0.9))+
  geom_text(aes(label = contr_incum_FA$ge_winner, hjust = 1),position = position_dodge(width = 0.9), color="red")
}
